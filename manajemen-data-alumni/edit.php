...
<head>
    ...
    <link rel="stylesheet" href="style/edit.css?v=1.1">
</head>
<body>
...
<option <?= $d['jurusan']=="Teknik Komputer dan Jaringan"?"selected":"" ?>>Teknik Komputer dan Jaringan</option>
<option <?= $d['jurusan']=="Animasi"?"selected":"" ?>>Animasi</option>
<option <?= $d['jurusan']=="Teknik Jaringan Akses Telekomunikasi"?"selected":"" ?>>Teknik Jaringan Akses Telekomunikasi</option>
</select>
